    ...
    if (activeIndex == ((builtChildren.length) - widget.visible)) {
      for (int a = 0; a < widget.visible; a++) {
        ...
        builtChildren[activeIndex + a]['width'] =
            a == 0 ? widget.trailingChildWidth : call / (widget.visible - 1);
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext ctx, BoxConstraints constrains) {
        useWidth = widget.width == null ? constrains.maxWidth : widget.width!;
        useHeight =
            widget.height == null ? constrains.maxHeight : widget.height!;
